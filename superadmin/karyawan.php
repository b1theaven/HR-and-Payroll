...
<div class="container">
    ...
    if (isset($_GET['pesan'])) {
        if ($_GET['pesan'] == "oke") {
            echo "<div class='alert alert-success'>Karyawan telah ditambahkan!</div>";
        }
    }
    ?>
    <?php
    ...
    <div class="panel" data-aos="fade-down" data-aos-delay="200">
        ...
        <div class="panel-body">
            <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 10px; margin-bottom: 15px;">
                <div>
                    <a href="karyawan_tambah.php" class="btn btn-sm btn-info">Tambah</a>
                    <a href="karyawan_excel.php" class="btn btn-sm btn-success ml-1">Input Excel</a>
                    <a href="karyawan_laporan.php" target="_blank" class="btn btn-sm btn-danger">Buat Laporan</a>
                </div>
                <form method="GET" class="form-inline" style="margin: 0;">
                    <input type="text" name="search" class="form-control input-sm" placeholder="Cari karyawan..." value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>" style="width: 250px; display: inline-block;">
