...
<body>
    ...
    header("location:../index.php?pesan=troll");
    exit;
    }
    ?>
...
<div id="pdfModal" class="pdf-modal">
    <div class="pdf-modal-content">
        ...
        <button class="pdf-close" onclick="tutupPDF()">✕</button>
...
function lihatPDF(urlAsli) {
    const finalURL = convertToDrivePreview(urlAsli);
