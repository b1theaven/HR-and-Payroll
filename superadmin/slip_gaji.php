    ...
    <div class="panel" data-aos="fade-down" data-aos-delay="200">
        ...
        <div class="panel-body">
            <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 10px; margin-bottom: 15px;">
                <div>
                    <a href="slipgaji_tambah.php" class="btn btn-sm btn-info">Tambah</a>
                    <a href="slipgaji_excel.php" class="btn btn-sm btn-success ml-1">Input Excel</a>
                    <a href="slipgaji_laporan.php" target="_blank" class="btn btn-sm btn-danger">Buat Laporan</a>
                </div>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="slipgaji_hapus.php?id=<?php echo $d['nik']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus slip gaji <?= $d['nik'] ?>?')">Hapus</a>
                        </td>
                    </tr>
                <?php
                }
