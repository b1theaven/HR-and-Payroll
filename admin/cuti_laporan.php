...
<head>
    ...
    <title>Laporan_Cuti_Karyawan_SPS_<?= date('dMY') ?></title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        ...
        <p><b>LAPORAN REKAPITULASI PENGAJUAN CUTI KARYAWAN</b></p>
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td class="text-center"><?= date('d-m-Y', strtotime($d['tanggal_mulai'])) ?> s.d. <?= date('d-m-Y', strtotime($d['tanggal_selesai'])) ?></td>
